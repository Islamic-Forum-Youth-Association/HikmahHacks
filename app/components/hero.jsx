...
function Hero() {
    ...
    return (
        <>
        <motion.div initial="hidden" animate="visible" variants={containerVariants} className="w-full min-h-[100vh] bg-[#26272D] flex flex-col-reverse xl:gap-x-32 xl:flex-row justify-evenly items-center flex-grow md:pt-20 xl:pt-10  md:p-3 xl:px-24 py-10 overflow-clip">
