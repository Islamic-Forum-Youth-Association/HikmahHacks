...
function Hero() {
    ...
    return (
        <>
        <div id="home" className="w-full min-h-[100vh] bg-[#26272D] flex flex-col-reverse xl:gap-x-32 xl:flex-row justify-evenly items-center flex-grow md:pt-20 xl:pt-10 xl:ml-40 md:p-3 xl:px-24 py-10 overflow-clip">


            <div className="text-section  mx-1/2">
                <h1 className="md:text-6xl text-5xl xl:text-left text-center text- text-white font-extrabold text-pretty" >Hack the Ummah <span className="xl:block inline-block">with Hikmah</span> </h1>
                <p className="mt-5 xl:text-left text-center  text-gray-400">Register today for a weekend of inspiration and creation!</p> 
                
                <div className='flex justify-center  xl:pt-10 '><button className=' text-[#4FFFA0] -translate-y-1 rounded-full bg-[#676767] py-3 px-12 font-bold mt-10 text-xl' onClick={() => {alert("Check out our social media pages for announcements on registration!")}}><b>REGISTER</b></button></div>
            </div>
