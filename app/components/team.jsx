    ...
    return (
        ...
        <div 
            ...
            <div className='flex flex-col gap-10 justify-center text-2xl p-32 text-center'>
                ...
                <button className='px-16 py-0 md:py-4 bg-[#676767] text-[#4FFFA0] hover:bg-[#3a3a3a] transition-all ease-linear duration-150 rounded-full'><a href="https://forms.gle/d1dTWzrsV7tJYGP66">JOIN TODAY</a></button>
            </div>
        </div>
    );
}
